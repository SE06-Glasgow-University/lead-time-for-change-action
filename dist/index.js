...
// required packages
const { request } = __nccwpck_require__(476); // to handle the http requests to GitHub API
const core = __nccwpck_require__(8); // to get input from workflow/set output to workflow
const github = __nccwpck_require__(751); // to get the release object from the payload on trigger
